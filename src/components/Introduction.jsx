      ...
      <div id="intro" className="card intro_container">
        ...
        <div className="footer text-center">
         <div className="cf_and_d_explanation text-muted">
            ...
            fee would be returned to households as a monthly dividend.<br/><br/>This calculator estimates the impact of both the carbon fee and dividend for your specific household
